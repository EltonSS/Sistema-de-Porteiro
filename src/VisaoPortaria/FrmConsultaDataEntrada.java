...
public class FrmConsultaDataEntrada extends javax.swing.JInternalFrame {
    ...
    public FrmConsultaDataEntrada(JInternalFrame p) throws SQLException {
    ...
    private void BtConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtConsultarActionPerformed
        ...
        if (consulta == "entradaVeiculo") {
            ...
            frmConsultasEntradaSaidaVeiculos.atualizarTabelaEntradaVeiculoData();
            dispose();
        } else {
            if (consulta == "entradaPessoa") {
                FrmConsultasEntradaSaidaPessoas frmConsultasEntradaSaidaPessoas = (FrmConsultasEntradaSaidaPessoas) parente;
                try {
                    formataDataVariavel();
                } catch (ParseException ex) {
                    Logger.getLogger(FrmConsultaDataEntrada.class.getName()).log(Level.SEVERE, null, ex);
                }
                frmConsultasEntradaSaidaPessoas.setData_ini(dataIni);
                frmConsultasEntradaSaidaPessoas.setData_fin(dataFin);
                frmConsultasEntradaSaidaPessoas.atualizarTabelaEntradaPessoaData();
                dispose();
            }
        }
